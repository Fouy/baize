...
(function() {
    ...
    $('#exampleTableEvents').bootstrapTable({
        ...
        url: "/goodscategory/list?parentId="+parentId,
        ...
        columns: [{
            ...
            formatter:function(value, row, index){
                ...
                //a = a + '<br/><button class="btn btn-success btn-sm" type="button" onclick=fieldWin('+value+')><i class="fa fa-reorder"></i> <span class="bold">属性</span></button>';
                return a;
            } 
        }]
    });
...
function addWin(){
  //页面层
    parent.layer.open({
        ...
        content: '/goodscategory/childadd?parentId='+$('#parentId').val(),
        end: function () {
            search();
        }
    });
...
function editWin(categoryId){
    parent.layer.open({
        ...
        skin: 'layui-layer-rim', //加上边框
        area: ['1000px', '650px'], //宽高
        content: '/goodscategory/childedit?categoryId='+categoryId,
        end: function () {
            search();
        }
    });
